  ...
  return (
    <div className="flex flex-col items-center justify-center gap-6 py-24 text-center">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">Cuando realices tu primer pedido aparecerá aquí.</p>
      </div>
      <Button variant="link" onClick={() => navigate('/catalog')}>Ver catálogo</Button>
    </div>
  )
}
    ...
    <div className="container py-8">
          ...
          >
            ...
            <CardContent className="flex items-center justify-between pt-0 text-sm text-muted-foreground">
              <div className="flex items-center gap-4">
                ...
                <span>{order.num_items} {order.num_items === 1 ? 'artículo' : 'artículos'}</span>
              </div>
      ...
      {totalPages > 1 && (
        <div className="mt-6 flex items-center justify-center gap-4">
          ...
          <Button variant="outline" size="icon" onClick={() => setPage(currentPage + 1)} disabled={currentPage === totalPages}>
